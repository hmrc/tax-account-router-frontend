...
object TwoSVMandatoryRegistrationPage extends WebPage {
  ...
  private val encodedContinueUrl = URLEncoder.encode(s"$hostPort/business-account", "UTF-8")
  private val failureUrl = URLEncoder.encode("/account", "UTF-8")
  private val queryString = s"origin=business-tax-account&failure=$failureUrl&continue=$encodedContinueUrl"
